...
with DAG(
    ...
    task_0 = PythonOperator(
        ...
        python_callable=lambda: print(f"Hello World from DAG: experiment_1_dag_5, Task: 0"),
    )
    ...
    task_2 = PythonOperator(
        ...
        python_callable=lambda: print(f"Hello World from DAG: experiment_1_dag_5, Task: 2"),
    )
